...
const ExternalLinkButton = ({
  ...
  return (
    <a
      ...
      className={cn(
        'inline-flex min-h-11 items-center gap-2 rounded-sm border px-4 py-2 text-body-sm font-semibold no-underline transition-[border-color,background-color,color,box-shadow] duration-150 focus-visible:outline-none focus-visible:shadow-focus-ring',
        variant === 'primary'
