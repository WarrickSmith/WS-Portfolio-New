...
const GoldPulseText = ({
  ...
  return (
    <Component
      ...
      className={cn(
        'inline-flex flex-wrap items-center justify-center uppercase [text-shadow:var(--text-shadow-gold-rest)] transition-[text-shadow] duration-[500ms] ease-[var(--ease-standard)] motion-reduce:transition-none motion-reduce:[text-shadow:var(--text-shadow-gold-hover)]',
        pulse &&
